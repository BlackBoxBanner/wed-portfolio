...
import { Menu as MenuIcon, X, Home, User, Code, Briefcase, GraduationCap, FolderOpen, BookOpen } from "lucide-react";
      ...
      setTimeout(() => {
        ...
        if (element) {
          ...
          setTimeout(() => {
            ...
            if (retryElement) {
              const elementTop = retryElement.getBoundingClientRect().top + window.pageYOffset;
              window.scrollTo({
                top: elementTop - 100,
                behavior: 'smooth'
              });
