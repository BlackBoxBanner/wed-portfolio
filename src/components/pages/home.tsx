        ...
        <div className='w-full relative flex flex-col justify-center space-y-6'>
          ...
          <div className='space-y-4'>
            <Paragraph className='text-lg md:text-xl leading-relaxed max-w-2xl'>
              Passionate about building web and mobile applications that people
              actually enjoy using. I code with purpose, learn with curiosity,
              and always aim to ship clean, maintainable solutions.
            </Paragraph>
            <Paragraph className='text-muted-foreground'>
              🎓 KMUTT Computer Engineering • 💼 Full-Stack Developer • 🚀
              Always Learning
            </Paragraph>
          </div>
          ...
          <div className='flex items-center gap-6 pt-2'>
            <Link
              href='https://github.com/BlackBoxBanner'
              target='_blank'
            ...
            <Link
              href='https://www.linkedin.com/in/sueksit'
              target='_blank'
              className='text-muted-foreground hover:text-primary transition-colors'
            >
              <svg className='w-6 h-6' fill='currentColor' viewBox='0 0 24 24'>
            ...
            <Link
              href='mailto:svac.mai+work@gmail.com'
              className='text-muted-foreground hover:text-primary transition-colors'
            >
              <svg
                className='w-6 h-6'
